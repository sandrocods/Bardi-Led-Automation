...
if get_device_bardi["status"]:
    ...
    if connect_device_bardi["status"]:
        ...
        # change theme to game mode type Music
        print("Changing theme to game mode type Music")
        connector_bardi.change_theme(
            theme_name="Game",
            theme_type="Music"
        )
        ...
        # change theme to Dream mode type Normal
        print("Changing theme to Dream mode type Normal")
        connector_bardi.change_theme(
            theme_name="Dream",
            theme_type="Normal"
        )
